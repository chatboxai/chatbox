...
- FABLE_REVIEW.md: **all P0 and P1 items are done, and all P2 security items (SEC-3, SEC-8, SEC-5)** (see FABLE_REVIEW §0 for the ✅ list; SEC-5 node-fetch@2 stripped at pack time shipped 2026-07-03, see ARCHITECTURE_NOTES). Remaining tiers: P2 (§6.3 tool-error unification, §9.1 a11y) and the low/opportunistic list below.
