...
- FABLE_REVIEW.md: **all P0 and P1 items are done, plus P2's SEC-3** (see FABLE_REVIEW §0 for the ✅ list; SEC-3 provider proxy → webSecurity:true shipped 2026-07-03). Remaining tiers: P2 (SEC-8 prod CSP, SEC-5 node-fetch, §6.3 tool-error unification, §9.1 a11y) and the low/opportunistic list below.
