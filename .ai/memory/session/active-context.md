...
- **Current Task**: Keep the imported helper harness useful for Chatbox without
  bringing over source-project baggage.
- **Primary Goal**: Keep `.ai/` generic and aligned with the real root-level
  Chatbox repo.
- **Current Focus**:
