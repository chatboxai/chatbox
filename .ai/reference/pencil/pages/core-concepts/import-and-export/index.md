...
- Source: https://docs.pencil.dev/core-concepts/import-and-export
...
- Press Cmd/Ctrl + K to open the AI chat and ask it to generate code from your design.
...
2. At the bottom of the properties panel, choose the desired size and format.
