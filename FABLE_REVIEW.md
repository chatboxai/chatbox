...
1. **P2:** §6.3 tool-error unification · §9.1 a11y labels.
...
| **P2 — next cycle** | ✅ SEC-3 (main-process provider proxy → `webSecurity: true`, shipped 2026-07-03 — see §0) · ✅ SEC-8 (prod CSP via build-time meta tag, shipped 2026-07-03 — see §0) · ✅ SEC-5 (node-fetch@2 stripped at pack time, shipped 2026-07-03 — see §0) · tool-error unification (§6.3) · a11y labels (§9.1) | Security P2 items all done; §6.3 and §9.1 are each ≤1 session. |
