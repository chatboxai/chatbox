...
|---|---|---|---|---|
| T001 | Produce the Pencil review packet for the inline weather dashboard, refresh controls, and degraded states. | must-have | no | Pencil review packet and approval gate |
