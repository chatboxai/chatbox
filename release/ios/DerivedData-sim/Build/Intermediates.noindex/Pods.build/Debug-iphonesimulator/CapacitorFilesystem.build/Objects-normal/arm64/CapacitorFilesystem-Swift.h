...
@interface FilesystemPlugin : CAPPlugin <CAPBridgedPlugin>
...
SWIFT_CLASS("_TtC19CapacitorFilesystem30LegacyFilesystemImplementation")
@interface LegacyFilesystemImplementation : NSObject
- (BOOL)downloadFileWithCall:(CAPPluginCall * _Nonnull)call emitter:(void (^ _Nonnull)(int64_t, int64_t))emitter config:(CAPInstanceConfiguration * _Nullable)config error:(NSError * _Nullable * _Nullable)error;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
