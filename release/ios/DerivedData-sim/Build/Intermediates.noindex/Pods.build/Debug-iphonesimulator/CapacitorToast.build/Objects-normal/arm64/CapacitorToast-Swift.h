...
#ifndef CAPACITORTOAST_SWIFT_H
#define CAPACITORTOAST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapacitorToast",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC14CapacitorToast5Toast")
@interface Toast : NSObject
+ (void)showToastIn:(UIViewController * _Nonnull)viewController text:(NSString * _Nonnull)text duration:(NSInteger)duration position:(NSString * _Nonnull)position completion:(void (^ _Nullable)(BOOL))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CAPPluginMethod;
@protocol CAPBridgeProtocol;
SWIFT_CLASS_NAMED("ToastPlugin")
@interface ToastPlugin : CAPPlugin <CAPBridgedPlugin>
