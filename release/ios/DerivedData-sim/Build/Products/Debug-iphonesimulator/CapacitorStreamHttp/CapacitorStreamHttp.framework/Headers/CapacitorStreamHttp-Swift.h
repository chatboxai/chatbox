...
#ifndef CAPACITORSTREAMHTTP_SWIFT_H
#define CAPACITORSTREAMHTTP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapacitorStreamHttp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("StreamHttpPlugin")
@interface StreamHttpPlugin : CAPPlugin <CAPBridgedPlugin, NSURLSessionDataDelegate>
...
- (void)startStream:(CAPPluginCall * _Nonnull)call;
- (void)cancelStream:(CAPPluginCall * _Nonnull)call;
