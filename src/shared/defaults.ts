...
// Reserved session IDs for special system-managed sessions.
// These ids will never be generated by uuid v4 and are checked by isSystemSession().
export const SESSION_MANAGER_ID = '__chatbox_session_manager__'

export const RESERVED_SESSION_IDS = new Set<string>([SESSION_MANAGER_ID])
